...
export declare interface AudioEffectsFeature extends AudioStreamFeature {
     ...
     */
    isSupported(effect: EchoCancellationEffect | DeepNoiseSuppressionEffect | 'BrowserEchoCancellation' | 'BrowserNoiseSuppression'): Promise<boolean>;
    /**
     * Start effects
...
export declare class CallClient {
    ...
    private _screenDeviceManager;
    private _disposed;
    private _vdi3Options;
...
export declare interface OptimalVideoCountCallFeature extends CallFeature {
    ...
    /**
     * Get the last reason for the optimal video count change
     * @public
     */
    readonly lastOvcChangeReason: OvcChangeReason;
    /**
...
/**
 *  Description:
 *      Ovc is a constraint that limits the maximum number of incoming video streams
 *  @public
 *  @property Bandwidth  -  Last change in OVC value was due to bandwidth constraints
 *  @property Performance  -  Last change in OVC value was due to performance constraints
 *  @property ExternalLimit  -  Last change in OVC value was due to different reasons
 */
export declare type OvcChangeReason = 'bandwidth' | 'performance' | 'externalLimit' | 'unknown';
...
export declare interface RemoteDiagnostics {
    /**
     * Local participant diagnostics will be sent to the remote participant if enabled
     */
    isSendingDiagnosticsEnabled: boolean;
    /**
     * Start sending diagnostics to the remote participant
     */
    startSendingDiagnostics(): void;
    /**
     * Stop sending diagnostics to the remote participant
     */
...
export declare interface TeamsCall extends CallCommon {
    ...
    /**
     * Denotes if this is an emergency call.
     */
    readonly isEmergencyCall?: boolean | undefined;
    /**
     * Add a participant.
     * @param participant - Participant to be added
     * @param options - AddTeamsParticipantOptions
     */
    addParticipant(participant: MicrosoftTeamsUserIdentifier | PhoneNumberIdentifier | MicrosoftTeamsAppIdentifier | TeamsExtensionUserIdentifier | UnknownIdentifier, options?: AddTeamsParticipantOptions): RemoteParticipant;
    /**
     * Remove a participant from this call.
     * @param participant - the participant to be removed.
     */
    removeParticipant(participant: MicrosoftTeamsUserIdentifier | PhoneNumberIdentifier | TeamsExtensionUserIdentifier | UnknownIdentifier): Promise<void>;
}
